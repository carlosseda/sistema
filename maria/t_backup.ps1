...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_backup` (`origin_disk_id`,`origin_partition_id`,`origin_path`,`destination_disk_id`,`destination_partition_id`,`destination_path`,`datetime_backup`,`error`) VALUES(3,2,"/win32/documentos",3,2,"/home/backup","2020-10-08",0)'
