...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_ram` (`brand`,`name`,`type`,`memory`,`cl`,`max_voltage`,`base_voltage`,`base_frequency`,`max_frequency`) VALUES("Kingston","HyperX","DDR4","16","16","1350","1200","2400","3466")'
