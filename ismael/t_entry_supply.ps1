...
# insertar un registro en la tabla t_entry_supply). 

$MYSQLCommand = New-Object MySql.Data.MySqlClient.MySqlCommand
$MYSQLCommand.Connection = $connection
$MYSQLCommand.CommandText='INSERT INTO `sistema`.`t_entry_supply` (`component_type`,`component_id`,`user_id`,`quantity`,`date`) VALUES("screen","1","1","1","2020-10-07")'
