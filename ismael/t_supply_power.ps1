...
# insertar un registro en la tabla t_supply_power). 

$MYSQLCommand = New-Object MySql.Data.MySqlClient.MySqlCommand
$MYSQLCommand.Connection = $connection
$MYSQLCommand.CommandText='INSERT INTO `sistema`.`t_supply_power` (`brand`,`name`,`watts`,`modular`) VALUES("Tacens","Anima","500","1")'
