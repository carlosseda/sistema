...
# encriptada. Para crearlo escribiremos lo siguiente en Powershell como administrador que arrancará el script:
#
...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_keyboard` (`brand`,`name`) VALUES("L-Link","quesrty")'
