...
# le damos click a Download donde pone "Windows (x86, 32-bit), MSI Installer": 
#
...
# encriptada. Para crearlo escribiremos lo siguiente en la consola de Powershell que arrancará el script (hay que abrir Powershell
# como administrador, ya que vamos a guardar el archivo en C: y ahí solo puede escribir el administrador):
#
...
# contraseña en texto plano $Credential.GetNetworkCredential().Password
...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_chasis` (`brand`,`name`,`form_factor`) VALUES("HP","chasis","atx")'
