# Para lanzar este archivo necesitamos instalar previamente en el Windows que lo ejecuta el siguiente módulo: Le damos click a download donde pone: Windows (x86, 32-bit), MSI Installer
#
...
# contraseña en texto plano $credential.G etNetworkCredential().Password
...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_incidence` (`computer_session_id`,`computer_component_id`,`description`,`datetime_opened`,`datetime_closed` ) VALUES("1","2","bla bla bla","2020-10-09 10:20:30","2020-10-09 10:20:30")'
