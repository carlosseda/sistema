...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_manteinance` (`computer_id`,`datetime_opened`,`datetime_closed`) VALUES(" 1","2020-10-07 10:30:30","2020-10-08 10:30:32")'
