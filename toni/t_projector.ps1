...
$MYSQLCommand.CommandText='INSERT into `sistema`.`t_projector` (`brand`,`name`,`reference`,`high_px`,`width_px`,`marker_id`,`start_date`,`end_date`) VALUES ("HP","IMPRESORA","6969699",1920,1080,4,"2020-10-08","2020-10-08")'
